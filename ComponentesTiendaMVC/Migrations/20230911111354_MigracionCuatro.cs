    ...
    public partial class MigracionCuatro : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdOrdenador = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DescripcionOrdenador = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ordenadores", x => x.IdOrdenador);
                });
            ...
            migrationBuilder.InsertData(
                table: "Componente",
                columns: new[] { "Id", "Almacenamiento", "Cores", "Descripcion", "Grados", "NumeroSerie", "OrdenadorId", "Precio", "TipoComponente" },
                values: new object[,]
                {
